...
finalMuons = cms.EDFilter("PATMuonRefSelector",
    ...
    cut = cms.string("pt > 3 && (isTrackerMuon || passed('CutBasedIdLoose') || passed('SoftCutBasedId') || passed('SoftMvaId') || passed('CutBasedIdGlobalHighPt') || passed('CutBasedIdTrkHighPt'))")
)
